...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function preload() {
      ...
      this.load.image('brick', './assets/images/brick-gold.png');
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function generateBricks(bricksGroup) {
      ...
      //console.log(brickGroupWidth)

      bricksGroup.position.setTo(this.game.world.centerX - brickGroupWidth, this.game.world.centerY - 250);
    }
  }, {
    key: 'setUpText',
